const mongoDBConnectionString = "MongoDB Connection String Here";
...
const data = dataService("mongodb+srv://test-user:test123@cluster0.62esx.mongodb.net/blog?retryWrites=true&w=majority");
const app = express();
